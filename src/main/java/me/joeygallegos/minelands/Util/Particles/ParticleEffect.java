package me.joeygallegos.minelands.Util.Particles;

/**
 * Created by Joey Gallegos
 * URL: joeygallegos.com
 * Date: 8/23/2014 // 8:22 PM
 */
...
public enum ParticleEffect {
    ...
    private static List<Player> getPlayers(Location center, double range) {
        ...
        // for all clarityplayers
//        for (Player player : Bukkit.getOnlinePlayers()) {
//            // if particle world = player world and is near the location and has particles enabled then add to list and show
